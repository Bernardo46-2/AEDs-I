...
class MyRobot : public Robot
{
    ...
    */
    ...
    void clearTxtFile ()
    {
        ...
        archive.open("Tarefa03E2.txt", std::ofstream::out | std::ofstream::trunc);
        archive.close(); 
    }
...
int main ( )
{
    ...
    robot2->create ( 2, 5, EAST, 0, "Jarel" ); //'J'
    //executar tarefa
    robot2->doTask1();
    robot1->doTask2();
    robot2->doTask3();
