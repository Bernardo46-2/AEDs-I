/*
Guia01E3 - v0.0. - 08/03/2022
Author: Bernardo Marques Fernandes - 774119

Para compilar em uma janela de comandos (terminal):
No Linux : g++ -o Guia01E3 ./Guia01E3.cpp
No Windows: g++ Guia01E3.cpp -o Guia01E3.exe
Para executar em uma janela de comandos (terminal):
No Linux : ./Guia01E3
No Windows: Guia01E3
*/
// lista de dependencias
#include "myKarel.hpp" //(comentário: necessario estar na mesma pasta)
...
class MyRobot : public Robot
{
     ...
     void turnBack ( )
   {
    ...
    //pegar beepers no local
    void pickBeepers ( int n )
    {
        int pickN = 0;
        for ( pickN = 1; pickN <= n; pickN = pickN + 1)
        {
            pickBeeper();
        }
    }

    //colocar beepers carregados
    void putBeepers ( int n )
    {
        int putN = 0;
        for ( putN = 1; putN <= n; putN = putN + 1)
        {
            putBeeper();
        }
    }
