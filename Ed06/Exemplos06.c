...
int main(){
    ...
    do{
        ...
        printf ("\nMenu\n");
        printf ("\n0 - Parar\n");
        printf ("1 - Exemplo0601\n");
        printf ("2 - Exemplo0602\n");
        printf ("3 - Exemplo0603\n");
        printf ("4 - Exemplo0604\n");
        printf ("5 - Exemplo0605\n");
        printf ("6 - Exemplo0606\n");
        printf ("7 - Exemplo0607\n");
        printf ("8 - Exemplo0608\n");
        printf ("9 - Exemplo0609\n");
        printf ("10 - Exemplo0610\n");
