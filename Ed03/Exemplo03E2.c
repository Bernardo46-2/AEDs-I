...
void method15 ()
{
    ...
    IO_printf ("\n");
    IO_printf ("quantidade de caracteres: %d", contador);
    IO_printf ("\n");
...
void method17()
{
    ...
    //acoes
    a = IO_readint("Insira o limite inferior de um intervalo (a): ");
    b = IO_readint("Insira o limite superior de um intervalo (b): ");

    if (b<a)
    {
        IO_printf ("\n");
        IO_println ("Valores invalidos. (b < a)");
    }
    else
    {
        n = IO_readint("Insira a quantidade de valores a serem testados: ");
        int array[n];

        //determinar valores
        for (x = 0; x < n; x++)
        {
            IO_printf ("Insira o valor %d", (x+1));
            array[x] = IO_readint (": ");
            
            if ((a <= array[x]) && (array[x] <= b) && (array[x] % 5 == 0))
            {
                contador++;
            }
        }
        ...
        IO_printf ("\n");
        IO_printf ("%d desses valores sao multiplos de 5 e estao no intervalo [%d,%d].\n", contador, a, b);
        IO_printf ("Sao eles: ");
...
void method18()
{
    ...
    else
    {
        ...
        for (x = 0; x < n; x++)
        {
            ...
            if ((a <= array[x]) && (array[x] <= b) && (array[x] % 5 == 0) && (array[x] % 3 != 0))
            {
                contador++;
            }
        }
        ...
        //imprimir
        IO_printf ("\n");
        IO_printf ("%d desses valores sao multiplos de 5,nao sao multiplos de 3 e\n", contador);
        IO_printf ("estao no intervalo [%d,%d]\n", a, b);
        IO_printf ("Sao eles: ");
...
void method19()
{
    ...
    //acoes
    a = IO_readdouble("Insira o limite inferior de um intervalo (a): ");
    b = IO_readdouble("Insira o limite superior de um intervalo (b): ");
    ...
    else
    {
        ...
        {
            IO_printf ("Insira o valor %d", (x+1));
            array[x] = IO_readdouble (": ");
            
            if ((a < array[x]) && (array[x] < b) && (int)(array[x]) % 2 != 0.0)
            {
                contador++;
            }
        }
        ...
        //imprimir
        IO_printf ("\n");
        IO_printf ("%d desses valores possuem a perte inteira impar e pertencem\n", contador);
        IO_printf ("ao intervalo [%lf,%lf]\n", a, b);
        IO_printf ("Sao eles: ");
...
void method20()
{
    ...
    //acoes
    a = IO_readdouble("Insira o limite inferior de um intervalo que seja maior que 0 (a): ");
    b = IO_readdouble("Insira o limite superior de um intervalo que seja menor que 1 (b): ");
    ...
    {
        IO_printf ("\n");
        IO_println ("Valor invalido. (a < 0)");
    }
    else if (b>1)
    {
        IO_printf ("\n");
        IO_println ("Valor invalido. (b > 1)");
    }
    else
    {
        n = IO_readint("Insira a quantidade de valores a serem testados: ");
        ...
        //retirar parte inteira
        double valorFracionado[n];
        for (x = 0; x < n; x++)
        {
            valorFracionado[x] = array[x] - (int)array[x];
        }
        ...
        for (x = 0; x < n; x++)
        {
            ...
            if ((a >= valorFracionado[x]) || (valorFracionado[x] >= b))
            {
                contador++;
            }
        }
        ...
        //imprimir
        IO_printf ("\n");
        IO_printf ("%d desses valores possuem o valor fracionario fora do intervalo (%lf,%lf)\n", contador, a, b);
        IO_printf ("Sao eles: ");
...
void methodE1()
{
    ...
    for (x = 0; x < strlen(palavra); x++)
    {
        ...
        {
            strcat (simbolos, IO_toString_c(simbolo));
        }
    }
    IO_printf ("Os simbolos nao alfanumericos dessa cadeia de caracteres sao: %s", simbolos);
    IO_printf ("\n");
...
void methodE2()
{
    ...
    for (x = 0; x < strlen(palavra); x++)
    {
        if (('A' <= palavra[x] && palavra[x] <= 'z') || ('a' <= palavra[x] && palavra[x] <= 'z'))
        {
            letra++;
        }
    }
    ...
    if (letra == 0)
    {
        IO_printf ("Cadeia de caracteres possui apenas simbolos que nao sao letras\n");
    }
    else if (letra == 1)
    {
        IO_printf ("Cadeia de caracteres possui %d letra.\n", letra);
    }
    else
    {
        IO_printf ("Cadeia de caracteres possui %d letras.\n", letra);
    }
    IO_printf ("\n");
...
int main ( )
{
    ...
    do
    {
        ...
        IO_println ("15 - Exemplo0315");
        IO_println ("16 - Exemplo0316");
        IO_println ("17 - Exemplo0317");
        IO_println ("18 - Exemplo0318");
        IO_println ("19 - Exemplo0319");
        IO_println ("20 - Exemplo0320");
        IO_println ("21 - Exemplo03E1");
        IO_println ("22 - Exemplo03E2");
        IO_println ( "" );
