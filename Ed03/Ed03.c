...
{
    //identificar
    IO_id ("Exemplo03E1 - MethodE1 - v1.0");

    //dados
    chars palavra = IO_new_chars (STR_SIZE);
    char letra = '_';

    palavra = IO_readln ("Insira uma cadeia de caracteres: ");
    printf("\nSimbolos nao alfanumericos sao: ");
...
{
    //identificar
    IO_id ("Exemplo03E2 - MethodE2 - v1.0");
    ...
    if (teste==true)
    {
        printf ("\nCadeia de caracteres possui letras.\n");
    }
    else
    {
        printf ("\nCadeia de caracteres possui apenas caracteres que nao sao letras.\n");
    }
