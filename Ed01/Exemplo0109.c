...
int main ( int argc, char* argv [ ] )
{
    ...
    x = (int) z;  //codigo inteiro equivale ao caractere
    printf ("04. %s%d->%c\n", "x = ", x, z);

    x = (int) y;  //parte inteira real
    printf ("05. %s%d->%lf\n", "x = ", x, y);
    ...
    x = (int) '0'; //codigo equivalente ao caractere
    z = (char) x;  //codigo equivalente ao codigo inteiro
    printf ("07. %s%c->%d\n", "z= ", z, x);
