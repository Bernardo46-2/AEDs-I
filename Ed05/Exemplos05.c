...
int main ( )
{
    ...
    do
    {
        ...
        IO_println ( " 6 - Somar certa quantidade de valores pares" );
        IO_println ( " 7 - Somar certa quantidade de fracoes" );
        IO_println ( " 8 - Somar certa quantidade de fracoes (alternativo)" );
        IO_println ( " 9 - Somar certa quantidade de fracoes (alternativo) (alternativo)" );
